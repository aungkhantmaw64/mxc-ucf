...
#define ITM_LSR_ByteAcc_Pos \
  (ITM_LSR_BYTEACC_Pos) /*!< \deprecated ITM_LSR_ByteAcc_Pos */
#define ITM_LSR_ByteAcc_Msk \
  (ITM_LSR_BYTEACC_Msk) /*!< \deprecated ITM_LSR_ByteAcc_Msk */

#define ITM_LSR_Access_Pos \
  (ITM_LSR_ACCESS_Pos) /*!< \deprecated ITM_LSR_Access_Pos */
#define ITM_LSR_Access_Msk \
  (ITM_LSR_ACCESS_Msk) /*!< \deprecated ITM_LSR_Access_Msk */

#define ITM_LSR_Present_Pos \
  (ITM_LSR_PRESENT_Pos) /*!< \deprecated ITM_LSR_Present_Pos */
#define ITM_LSR_Present_Msk \
  (ITM_LSR_PRESENT_Msk) /*!< \deprecated ITM_LSR_Present_Msk */
